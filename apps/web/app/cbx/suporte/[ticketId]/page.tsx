...
type Comment = { id: string; author_name: string; body: string; audience: 'internal' | 'client'; created_at: string }
      ...
      <CbxCard title="Comentários e interações">
        ...
        <ul className="space-y-2">
          {comments.map((c) => {
            ...
            return (
              <li key={c.id} className={`rounded-lg px-3 py-2 ${isClient ? 'border border-sky-500/20 bg-sky-500/5' : 'bg-slate-900/40'}`}>

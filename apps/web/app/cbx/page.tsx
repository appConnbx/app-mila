  ...
  return (
    <div className="mx-auto max-w-md py-20 text-center">
      ...
      <p className="mt-3 text-sm leading-relaxed text-slate-400">
        Sua conta já tem acesso ao portal, mas ainda não há áreas liberadas para você. Peça a um
        administrador para atribuir suas permissões (CEO, Financeiro, Comercial, Suporte ou
        Administração) em <span className="text-slate-300">Administração</span>.
      </p>
    </div>
  );
}

      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        {hasPerm(me, "COMERCIAL") && (
          <div className="flex gap-2">
            <Link
              href="/cbx/comercial/tipos"
              className="inline-flex items-center justify-center rounded-lg border border-white/10 px-3 py-1.5 text-sm text-slate-300 transition hover:bg-white/10 hover:text-white"
            >
              Tipos de negócio
            </Link>

...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const bizLangs = { 'pt-BR': `${SITE}/br-business`, en: `${SITE}/en-business`, es: `${SITE}/es-business` }
  const perLangs = { 'pt-BR': `${SITE}/br-personal`, en: `${SITE}/en-personal`, es: `${SITE}/es-personal` }

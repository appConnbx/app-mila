    ...
    <div className="min-h-screen bg-surface text-slate-200">
      <div className="mx-auto max-w-3xl px-4 py-14">
        ...
        <h1 className="mt-4 text-3xl font-extrabold text-white">
          Política de Privacidade — appMila
        </h1>
        ...
        <P>
          ...
          da Informação LTDA, CNPJ 49.848.097/0001-86, Piracicaba/SP. Esta política explica, em
          conformidade com a LGPD (Lei nº 13.709/2018), como tratamos seus dados no site, no sistema
          web, no aplicativo móvel e no agente desktop.
        </P>

        <H>1. Dados que coletamos</H>
        <P>
          <strong>Conta:</strong> nome, e-mail e senha (armazenada de forma criptografada).{" "}
          <strong>Conteúdo:</strong> demandas, eventos, observações e demais informações que você ou
          sua organização registram. <strong>Perfil:</strong> foto, telefone e habilidades, se você
          os adicionar. <strong>Uso técnico:</strong> registros de acesso e atividade necessários à
          segurança e ao funcionamento (ex.: controle de sessão).
        </P>
        ...
        <P>
          ...
          transcrição; somente o texto resultante vira uma demanda, que você pode revisar e recusar
          antes de criar.
        </P>
        ...
        <P>
          ...
          processar assinaturas, prestar suporte e melhorar o produto. Não vendemos seus dados nem
          os usamos para publicidade de terceiros.
        </P>

        <H>4. Compartilhamento com operadores</H>
        <P>
          Usamos provedores que processam dados em nosso nome, sob contrato: Supabase (banco de
          dados e autenticação), Vercel (hospedagem do site e APIs), Groq (transcrição de voz) e
          Hotmart (processamento de pagamentos e assinaturas — os dados de pagamento são tratados
          diretamente pela Hotmart). Compartilhamos somente o necessário para cada finalidade.
        </P>
        ...
        <P>
          ...
          acima. Dúvidas: <strong>help@appmila.co</strong>.
        </P>
      </div>
    </div>
  );

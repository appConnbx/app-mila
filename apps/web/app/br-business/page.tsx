...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.appmila.co/br-business",
    languages: {
  ...
  openGraph: {
    ...
    description:
      "Capture por voz, delegue com prazo e acompanhe a equipe inteira. Planos anuais em até 12x.",
    url: "https://www.appmila.co/br-business",
    locale: "pt_BR",
    type: "website",
  },
};

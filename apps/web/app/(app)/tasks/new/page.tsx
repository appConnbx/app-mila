...
export default async function NovaDemandaPage({
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <form action={createDemand} className="mt-6 glass space-y-4 p-6">
        <div>
          ...
          <input
            ...
            name="title"
            required
            placeholder={isFamily ? t("demandPlaceholderFamily") : t("demandPlaceholder")}
            className={inputCls}
          />
        </div>
        ...
        <div className={isFamily ? "" : "grid gap-4 sm:grid-cols-2"}>
          ...
          {!isFamily && (
            <div>
              <label htmlFor="event_id" className={labelCls}>
                {t("event")}
              </label>

...
export default async function TeamPage({
  ...
  if (!org || !area || !team) redirect("/structure");
    ...
    <div>
      <Breadcrumb
        items={[
          ...
          { href: `/structure/org/${orgId}/area/${areaId}`, label: area.name },
          { label: team.name },
        ]}
      />
      ...
      <div className="mt-6 space-y-5">
        ...
        <StructureSettings
          ...
          redirectAfterDelete={`/structure/org/${orgId}/area/${areaId}`}
        />
        ...
        <Card title={t("members")}>
          <ul className="space-y-1.5">
            ...
            {memberRows.length === 0 && (
              <li className="text-sm text-slate-500">{t("noMembers")}</li>
            )}
          </ul>

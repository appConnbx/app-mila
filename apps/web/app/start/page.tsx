...
export default async function StartPage() {
  ...
  const checkout = (offBR: string, plan: string) =>
    isBR
      ...
      : `/subscribe?plan=${plan}&next=%2Fstart&lang=${locale}`;
  ...
  const corp = (intl: string, parcela: string, total: string) =>
    isBR
      ? {
          priceMain: `R$${parcela}`,
          priceUnit: "",
          priceSub: `12x · ou R$${total} à vista (plano anual)`,
        }
  ...
  const plans = {
    starter: {
      name: "Starter",
      users: tl("plans.starterUsers"),
      href: checkout("wyitwc3d", "starter"),
      ...corp("87", "297", "3.564"),
    },
    growth: {
      name: "Growth",
      users: tl("plans.growthUsers"),
      href: checkout("2kxlbff2", "growth"),
      ...corp("167", "497", "5.964"),
    },
    scale: {
      name: "Scale",
      users: tl("plans.scaleUsers"),
      href: checkout("abpzxjap", "scale"),
      ...corp("337", "697", "8.364"),
    },
    enterprise: {
      name: "Enterprise",
      users: tl("plans.enterpriseUsers"),
      href: checkout("yl7fpa6u", "enterprise"),
      ...corp("667", "1.117", "13.404"),
    },
    family: {
      name: "Family",
      users: tl("plans.familyUsers"),
      href: checkout("i67ovflk", "family"),
      ...fam("13", "97", "8,08"),
    },
    familyplus: {
      name: "Family Plus",
      users: tl("plans.familyPlusUsers"),

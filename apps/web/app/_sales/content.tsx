...
export const brEmpresa: SalesContent = {
  ...
  pains: [
    { p: '“Ficou combinado, mas ninguém anotou.”', r: 'Toda decisão vira tarefa com responsável e prazo, na hora.' },
    { p: '“Não sei o que a equipe está fazendo.”', r: 'Painéis em tempo real por pessoa, equipe e área.' },
    { p: '“Cobro pelo WhatsApp e me perco.”', r: 'Um só lugar para delegar, acompanhar e concluir.' },
  ],
  ...
  features: [
    { t: 'Captura por voz', d: 'Segure o microfone, fale e solte: a transcrição vira demanda com prazo. No computador e no celular.' },
    { t: 'Estrutura corporativa', d: 'Organização, áreas e equipes — com permissões e visão por escopo para cada gestor.' },
    { t: 'Delegação com prazo', d: 'Defina responsável, prazo e prioridade. Cada um sabe exatamente o que fazer.' },
    { t: 'Painéis de produtividade', d: 'Acompanhe o andamento por pessoa, equipe e área, e destaque quem entrega.' },
    { t: 'Gadget no computador', d: 'Um atalho discreto na lateral da tela (Windows): pendências sempre à vista e criação em 1 toque.' },
    { t: 'Eventos que viram tarefa', d: 'Reuniões e follow-ups capturam as demandas combinadas, sem nada se perder.' },
  ],
  ...
  plansSub: 'Plano anual, cobrado em até 12x no cartão. Todo colaborador ganha um Family Plus licenciado enquanto a empresa mantiver o plano.',
  plans: corpPlansBR({
...
export const brPessoal: SalesContent = {
  ...
  painSubtitle: 'Mercado, contas, escola, consertos, remédios, compromissos. O que não está anotado vira esquecimento — e o esquecimento vira discussão.',
  pains: [
    { p: '“Achei que você tinha resolvido.”', r: 'Cada combinado tem dono e prazo. Sem mal-entendido.' },
    { p: '“Esqueci de pagar / marcar / comprar.”', r: 'Lembretes para não deixar nada passar.' },
    { p: '“Fico sobrecarregado(a) com tudo.”', r: 'Divida as tarefas de forma justa e visível para todos.' },
  ],

  solKicker: 'A solução',
  solTitle: 'A casa toda organizada, no mesmo lugar',
  solDesc: 'Sem burocracia: cadastre as pessoas da família e organize o que precisa ser feito. Simples de usar até para quem não gosta de aplicativo.',
  features: [
    { t: 'Captura por voz', d: 'Lembrou de algo? Fale e vira tarefa com prazo. No celular ou no computador.' },
    ...
    { t: 'Comunicação clara', d: 'O que foi combinado fica registrado — e deixa de virar discussão.' },
  ...
  guaranteeBody: 'Use por 7 dias. Se não fizer sentido para a sua família, devolvemos 100% do valor — sem burocracia.',
...
export const enBusiness: SalesContent = {
  ...
  pains: [
    { p: '“We agreed on it, but nobody wrote it down.”', r: 'Every decision becomes a task with an owner and a deadline, instantly.' },
    { p: '“I don’t know what my team is doing.”', r: 'Real-time dashboards by person, team and area.' },
    { p: '“I chase people on chat and lose track.”', r: 'One place to delegate, follow up and complete.' },
  ],
  ...
  features: [
    { t: 'Voice capture', d: 'Hold the mic, speak, release: the transcript becomes a task with a deadline. On desktop and mobile.' },
    { t: 'Corporate structure', d: 'Organization, areas and teams — with permissions and scoped views for each manager.' },
    { t: 'Delegation with deadlines', d: 'Set owner, due date and priority. Everyone knows exactly what to do.' },
    { t: 'Productivity dashboards', d: 'Track progress by person, team and area, and spotlight top performers.' },
    { t: 'Desktop gadget', d: 'A discreet shortcut docked to your screen edge (Windows): tasks always in sight, one-tap capture.' },
    { t: 'Meetings that become tasks', d: 'Meetings and follow-ups capture every agreed task, so nothing slips.' },
  ],
  ...
  plansSub: 'Monthly subscription. Every employee gets a licensed Family Plus while the company keeps the plan.',
  plans: corpPlansINTL({
...
export const enPersonal: SalesContent = {
  ...
  painSubtitle: 'Groceries, bills, school, repairs, appointments. What isn’t written down gets forgotten — and forgetting turns into arguments.',
  pains: [
    { p: '“I thought you had handled it.”', r: 'Every agreement has an owner and a deadline. No misunderstandings.' },
  ...
  solDesc: 'No bureaucracy: add your family members and organize what needs doing. Simple enough even for people who dislike apps.',
  features: [
    { t: 'Voice capture', d: 'Remembered something? Say it and it becomes a task with a deadline. On phone or computer.' },
    ...
    { t: 'Home and personal together', d: 'Groceries, bills, school and appointments in one place.' },
    { t: 'Clear communication', d: 'What was agreed is on record — and stops becoming an argument.' },
  ...
  guaranteeBody: 'Use it for 7 days. If it isn’t right for your family, we refund 100% — no hassle.',
...
export const esBusiness: SalesContent = {
  ...
  pains: [
    { p: '“Lo acordamos, pero nadie lo anotó.”', r: 'Cada decisión se convierte en tarea con responsable y plazo, al instante.' },
    { p: '“No sé qué está haciendo mi equipo.”', r: 'Paneles en tiempo real por persona, equipo y área.' },
    { p: '“Persigo a la gente por chat y me pierdo.”', r: 'Un solo lugar para delegar, dar seguimiento y completar.' },
  ],
  ...
  features: [
    { t: 'Captura por voz', d: 'Mantén el micrófono, habla y suelta: la transcripción se vuelve tarea con plazo. En computadora y móvil.' },
    { t: 'Estructura corporativa', d: 'Organización, áreas y equipos — con permisos y vistas por alcance para cada responsable.' },
    { t: 'Delegación con plazo', d: 'Define responsable, fecha y prioridad. Cada uno sabe exactamente qué hacer.' },
    { t: 'Paneles de productividad', d: 'Sigue el avance por persona, equipo y área, y destaca a quien entrega.' },
    { t: 'Gadget de escritorio', d: 'Un acceso discreto en el borde de la pantalla (Windows): tareas siempre a la vista, captura en un toque.' },
    { t: 'Reuniones que se vuelven tareas', d: 'Reuniones y seguimientos capturan cada tarea acordada, sin que nada se escape.' },
  ],
  ...
  plansSub: 'Suscripción mensual. Cada empleado recibe un Family Plus con licencia mientras la empresa mantenga el plan.',
  plans: corpPlansINTL({
...
export const esPersonal: SalesContent = {
  ...
  painSubtitle: 'Súper, cuentas, escuela, arreglos, citas. Lo que no se anota se olvida — y el olvido se vuelve discusión.',
  pains: [
    { p: '“Pensé que lo habías resuelto.”', r: 'Cada acuerdo tiene responsable y plazo. Sin malentendidos.' },
    { p: '“Olvidé pagar / agendar / comprar.”', r: 'Recordatorios para que nada se escape.' },
    { p: '“Cargo con todo yo solo(a).”', r: 'Reparte las tareas de forma justa y visible para todos.' },
  ],

  solKicker: 'La solución',
  solTitle: 'Todo el hogar, organizado en un solo lugar',
  solDesc: 'Sin burocracia: agrega a los miembros de tu familia y organiza lo que hay que hacer. Simple incluso para quien no le gustan las apps.',
  features: [
    { t: 'Captura por voz', d: '¿Te acordaste de algo? Dilo y se vuelve tarea con plazo. En el móvil o la computadora.' },
  ...
  guaranteeTitle: 'Garantía de 7 días',
  guaranteeBody: 'Úsalo 7 días. Si no encaja con tu familia, devolvemos el 100% — sin complicaciones.',

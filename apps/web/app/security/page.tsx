    ...
    <div className="min-h-screen bg-surface text-slate-200">
      <div className="mx-auto max-w-3xl px-4 py-14">
        ...
        <P>
          ...
          Abaixo, como protegemos seus dados em todas as camadas — site, sistema web, agente desktop
          e aplicativo móvel.
        </P>
        ...
        <P>
          Cada instância (empresa ou família) é isolada no banco de dados por políticas de Row Level
          Security: as regras de visibilidade são aplicadas pelo próprio banco, não apenas pela
          interface. Demandas privadas são visíveis somente aos envolvidos — inclusive para
          administradores.
        </P>
        ...
        <P>
          ...
          duração renovados automaticamente; no sistema web, sessões inativas expiram em 30 minutos.
        </P>
        ...
        <P>
          O tratamento de dados segue a LGPD — detalhes, direitos do titular e canal de contato na
          nossa{" "}

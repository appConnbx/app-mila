...
export default function Article() {
  return (
    <BlogArticleLayout slug="organizar-tarefas-por-voz">
      ...
      <P>
        No <B>trabalho</B>, capture as decisões de cada reunião como demandas com responsável e prazo, e acompanhe a
        execução em um só lugar — o que está aberto, em andamento e concluído. Em <B>casa</B>, a mesma lógica organiza
        a rotina da família: cada um sabe sua parte, sem cobrança. Tudo na mesma conta.
      </P>

...
export const POSTS: Post[] = [
  {
    ...
    excerpt:
      "Você fala, vira demanda com responsável e prazo. O jeito mais rápido de não perder o que foi combinado.",
    dateISO: "2026-06-18",
  ...
  },
  {
    ...
    excerpt:
      "Capture, delegue com prazo e acompanhe até concluir — o método para a equipe parar de perder demanda.",
    dateISO: "2026-06-18",
    dateLabel: "18 de junho de 2026",
    tag: "Trabalho",
  },
  {
    ...
    excerpt:
      "Cada um sabe sua parte, com prazo e lembrete — sem cobrança. Como organizar a rotina da família.",
    dateISO: "2026-06-18",
    dateLabel: "18 de junho de 2026",
    tag: "Família",
  },
  {
    ...
    excerpt:
      "Toda decisão de reunião com dono e prazo. Como garantir que o combinado vire execução.",
    dateISO: "2026-06-18",
    dateLabel: "18 de junho de 2026",
    tag: "Gestão",
  },
  {
    ...
    excerpt:
      "Compras esquecidas, divisão injusta, “achei que você ia fazer”: 5 dores de casa e como evitá-las.",
    dateISO: "2026-06-18",
    dateLabel: "18 de junho de 2026",
    tag: "Família",
  },
  {
    ...
    excerpt:
      "Decisões que somem, retrabalho, prazos estourados: 5 dores da equipe e como evitá-las.",
    dateISO: "2026-06-18",
    dateLabel: "18 de junho de 2026",
    tag: "Trabalho",
  },
  {
    ...
    excerpt:
      "Captura em segundos, nada se perde, status claro: 10 ganhos de um gestor de demandas rápido.",
    dateISO: "2026-06-18",
    dateLabel: "18 de junho de 2026",
    tag: "Produtividade",
  },
  {
    ...
    excerpt:
      "Ferramenta complexa que ninguém usa não resolve. Por que a simplicidade ganha na prática.",
    dateISO: "2026-06-18",
    dateLabel: "18 de junho de 2026",
    tag: "Gestão",
  },

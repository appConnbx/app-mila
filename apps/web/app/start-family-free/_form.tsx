...
export function SignupForm({ dict }: { dict: Dict }) {
  ...
  return (
    ...
    <form action={signupFamilyFree} autoComplete="off" className="space-y-4">
      ...
      <div>
        <label htmlFor="sf-name" className={label}>
          {dict.name}
        </label>
        <input
          id="sf-name"
      ...
      <div>
        <label htmlFor="sf-email" className={label}>
          {dict.email}
        </label>
        <input
          id="sf-email"
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div>
          <label htmlFor="sf-country" className={label}>
            {dict.country}
          </label>
          <select
            id="sf-country"
        ...
        <div>
          <label htmlFor="sf-doc" className={label}>
            {isBR ? dict.doc : dict.docOther}
          </label>
          <input
            id="sf-doc"
            name="document"
      ...
      <p className="text-center text-sm text-slate-500">
        {dict.morePlansPre}{" "}
        <Link href="/#pessoal" className="text-cyan-400 hover:underline">
          {dict.morePlansLink}
        </Link>
      </p>
    </form>

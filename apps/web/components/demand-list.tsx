...
import { DemandCard, type CardDemand, type DemandCardLabels } from './demand-card'
  ...
  return (
    <div className="mt-4">
      <div className="mb-3 flex justify-end">
        <div role="group" aria-label={toggle.view} className="inline-flex rounded-lg border border-white/10 bg-white/[0.03] p-1">
          {([

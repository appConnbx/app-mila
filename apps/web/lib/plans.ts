...
export const PLANS: Record<MilaPlan, PlanMeta> = {
  ...
  enterprise: { label: 'Enterprise', usd: '667', br: { off: 'yl7fpa6u', parcela: '1.117', total: '13.404' } },
  family: { label: 'Family', usd: '13', br: { off: 'i67ovflk', annual: '97', parcela: '8,08' } },
  family_plus: { label: 'Family Plus', usd: '17', br: { off: 'tfkn6adh', annual: '127', parcela: '10,58' } },
}

  ...
  return (
    <View style={s.wrap}>
      <Animated.View
        style={[
          s.badgeBox,
          { opacity: growOpacity, transform: [{ scale: Animated.multiply(growScale, idleScale) }] },
        ]}
      >
        ...
        <View style={s.mark}>
          ...
          <Animated.View
            style={[
              s.sweepGroup,
              { opacity: sweepOpacity, transform: [{ translateX: sweepX }, { rotate: "22deg" }] },
            ]}
          >
      ...
      <Animated.Text style={[s.brand, { opacity: word, transform: [{ translateY: wordY }] }]}>
        appMila
      </Animated.Text>
    </View>
  );
